...
RUN pip install django==2.2.4 chardet==3.0.4 defusedxml==0.6.0 django-appconf==1.0.3 django-braces==1.13.0
...
RUN pip install django-allauth==0.38.0 urllib3==1.25.7 wincertstore==0.2 pillow==6.2.0 django-debug-toolbar==1.11 whitenoise==4.1.2 gunicorn==19.9.0 dj-database-url==0.5.0 django-taggit
